...
All patterns must follow our standardized JSON structure as defined in the [pattern template](https://github.com/Invinsense/regex-intelligence-exchange/blob/master/patterns/TEMPLATE.md).
...
1. **Ensure your fork is up to date**:
   ```bash
   git remote add upstream https://github.com/Invinsense/regex-intelligence-exchange.git
   git fetch upstream
   git checkout master
...
2. **Navigate to your fork on GitHub**:
   - Go to https://github.com/YOUR-USERNAME/regex-intelligence-exchange
...
3. Check our [documentation site](https://invinsense.github.io/regex-intelligence-exchange/) for more information
